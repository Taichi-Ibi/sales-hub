...
export const TRACES: Trace[] = [
  // ── B商事（販売管理システム再構築 開発委託）──
  {
    ...
    at: '6/3 15:00',
    dealId: 'd-bshoji',
    excerpt: 'データ移行をスコープに追加・単価据え置きを軸に、6月中の契約合意を目指すことで一致。',
  },
  {
    id: 'tr-b2',
    ...
    dealId: 'd-bshoji',
    inboxItemId: 'in12',
    excerpt: '〔氏名①〕様より、提示済みの開発委託条件（データ移行を追加・単価据え置き）を承諾し契約書ドラフトの準備に入りたい旨の連絡。',
  },
  // ── 北斗電装（保守開発契約 解約条項交渉）──
  {
    id: 'tr-h1',
  ...
  // ── G産業（在庫管理システム刷新 新規提案）──
  {
    ...
    at: '5/27 16:00',
    dealId: 'd-gsangyo',
    excerpt: '現行の在庫管理システムの課題をヒアリング。先方は社内検討会（6/12）に向けて提案資料・概算見積の提供を希望。',
  },
  {
    id: 'tr-g2',
    ...
    at: '6/7 15:00',
    dealId: 'd-gsangyo',
    excerpt: '約束済みの提案資料・概算見積の送付が未対応のまま。6/12の先方社内検討会が迫っている。',
  },
  // ── 湊精機（システム保守契約 更新）──
  {
    id: 'tr-m1',
  ...
  },
  {
    ...
    at: '5/20 14:00',
    dealId: 'd-minato',
    excerpt: '保守対応の満足度は高い。値上げ余地は小さいが、現行条件での継続意向は強い（基幹システム保守）。',
  },
