...
export const DEALS: Deal[] = [
  {
    ...
    fields: [
      ...
      { label: '契約形態', value: 'システム開発委託（基本契約＋個別契約）' },
      { label: '初期開発費', value: '約2,400万円' },
      { label: '支払サイト', value: '30日' },
    ],
    notes: [
      { date: '6/9', text: '提案条件（データ移行を追加・単価据え置き）を先方が承諾。契約書ドラフトへ。' },
      { date: '5/28', text: 'データ移行もスコープに含めたい意向。単価据え置きが条件。' },
    ],
  ...
  },
  {
    ...
    fields: [
      ...
      { label: '契約形態', value: '保守開発（準委任・CT-2024-118）' },
  ...
  },
  {
    ...
    fields: [
      ...
      { label: '当社担当FS', value: '駒田 健' },
      { label: '契約形態', value: '新規（在庫管理システム刷新を提案中）' },
      { label: '先方キーマン', value: '山本課長（決裁者）' },
    ],
    notes: [
      { date: '6/7', text: '提案資料・概算見積の送付を約束済み（未対応）。6/12に先方社内検討会。' },
    ],
    updatedAt: '2026-06-10T06:00:00',
  },
  {
    ...
    fields: [
      ...
      { label: '先方窓口', value: '三浦（情報システム部）' },
      { label: '当社担当FS', value: '駒田 健' },
      { label: '契約形態', value: 'システム保守契約（HSK-2025-007）' },
