...
export const SEED_INBOX: InboxItem[] = [
  ...
  // ゲート通過で 北斗電装 のWikiが更新され、助言「ヨミ変化（確度低下）」が生成されるデモの主役。
  {
    ...
    body: 'お世話になっております。北斗電装の川島です。\n現行の保守開発契約 CT-2024-118 の解約条項について、通知期間を90日から45日に短縮いただけないか、社内で要望が出ております。月額120万円の取引規模を踏まえ、ご検討いただけますと幸いです。\n6/13までにご回答いただけますでしょうか。\n川島 紗英（kawashima@hokuto-densou.co.jp / 03-5550-8821）',
    status: '要確認',
    attention: [
  ...
  // ── 処理済み: 人が目視確認→AI解析→Wiki取込まで完了した例（= 痕跡）──
  {
    ...
    body: 'お世話になっております。B商事の田中です。\nご提案いただいた販売管理システム再構築の委託条件（データ移行を含むスコープ・単価据え置き）につきまして、社内承認が取れましたのでお受けいたします。\nつきましては開発委託契約書のドラフト準備をお願いできますでしょうか。6/17のお打ち合わせで条文の最終確認をできればと存じます。\n田中 一郎（tanaka@b-shoji.co.jp）',
    status: '処理済み',
  ...
  },
  {
    ...
    body: '湊精機の三浦さんから基幹システム保守契約の更新可否について連絡あり。年額360万円のままなら継続したい、6/12までに回答がほしいとのこと。対象は保守契約 HSK-2025-007。窓口は三浦さん（miura@minato-seiki.co.jp）です。一次返信お願いします。',
    status: '処理済み',
